 ...
 * coordinate system has eight neighboring points. Provided that the grid step =
 * 1.
 * It is necessary to write a function that takes a coordinate on the x-axis and
 * y-axis and returns a list of all the neighboring points. Points inside list
 * don't have to been sorted (any order is valid).
 * For Example:
...
public class Kata {
	 ...
	 public static int[][] cartesianNeighbor(int x, int y){    
		    int[][] arr={{x-1,y-1},{x-1,y},{x-1,y+1},{x,y-1},{x,y+1},{x+1,y-1},{x+1,y},{x+1,y+1}};
		        return arr;
		    }
